    ...
    <div class="container">
      <div class="favorite-top-buttons">
        <div class="back-button">
          <router-link to="/home/productslist/lists">
...
import FavoriteBanner from '@/components/Home/ImgBanner.vue'
import FavoriteItems from '@/components/Home/Favorite/FavoriteItems.vue'
